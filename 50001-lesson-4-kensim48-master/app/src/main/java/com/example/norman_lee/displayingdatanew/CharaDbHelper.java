...
public class CharaDbHelper extends SQLiteOpenHelper {
    ...
    private CharaData getDataFromCursor(int position, Cursor cursor){
        ...
        int desIndex = cursor.getColumnIndex(CharaContract.CharaEntry.COL_DESCRIPTION);
        int bitIndex = cursor.getColumnIndex(CharaContract.CharaEntry.COL_FILE);

        name = cursor.getString(nameIndex);
        description = cursor.getString(desIndex);
        byte[] bitmapByteArray = cursor.getBlob(bitIndex);
